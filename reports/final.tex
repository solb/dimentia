...
We evaluated the tool on a set of source codes stemming from competitive programming. Some of the examples were hand picked and other were randomly selected. The codes had between 53 and 200 lines of C++ or C code. The results are depicted in \Cref{table:eval-results}.
